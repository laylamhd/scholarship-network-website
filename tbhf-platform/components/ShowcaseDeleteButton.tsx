...
import { deleteShowcaseItem } from "@/app/(app)/showcase/actions";
import { colors, radius } from "@/lib/theme";

export default function ShowcaseDeleteButton({ itemId }: { itemId: string }) {
  ...
  return (
    <span style={{ display: "inline-flex", gap: 8, alignItems: "center" }}>
      ...
      <button type="button" disabled={pending} onClick={() => start(async () => { await deleteShowcaseItem(itemId); })} style={btn(true)}>
